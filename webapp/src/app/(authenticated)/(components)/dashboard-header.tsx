  ...
  return (
    <header className="flex h-16 items-center justify-between border-b bg-white px-0 md:px-2 dark:border-gray-800 dark:bg-gray-950"    >
      <div className="flex items-center gap-4">
        <CustomLink className="flex items-center gap-2" href="/home">
          <HeaderLogo2 className='max-h-10 max-w-10' />
        </CustomLink>
        {/* <nav className="hidden gap-4 text-sm font-medium md:flex">
          <CustomLink className="rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800" href="/home">
            Home
          </CustomLink>
          <CustomLink className="rounded-md px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800" href="/databases">
            Databases
          </CustomLink>
